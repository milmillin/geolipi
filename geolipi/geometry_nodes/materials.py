...
def create_edge_material_tree(
    material_name, mesh_color, edge_thickness=0.001, edge_color=(0.0, 0.0, 0.0), ao_strength=1.0
):
    """
...
def create_monotone_material(material_name, mesh_color, color_list, silhouette_color, shadow_size=0.1):
    ...
    init_rgb.inputs["Color"].default_value = (0.5, 0.5, 0.5, 1)
    ...
    for ii in range(num_color - 1):
        ...
        RGB_list[ii].inputs["Color"].default_value = (0.5, 0.5, 0.5, 1)
