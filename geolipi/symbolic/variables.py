...
class UnaryOperator(Operator):
    ...
    def default_spec(cls):
        return {
            "expr": {"type": "Expr"},
            "op": {
                "type": 'Enum["sin"|"cos"|"tan"|"log"|"exp"|"sqrt"|"abs"|"floor"|"ceil"|"round"|"frac"|"sign"|"normalize"|"norm"|"neg"]'
            },
        }
...
class BinaryOperator(Operator):
    ...
    def default_spec(cls):
        return {
            "expr_0": {"type": "Expr"},
            "expr_1": {"type": "Expr"},
            "op": {"type": 'Enum["add"|"sub"|"mul"|"div"|"pow"|"atan2"|"min"|"max"|"step"|"mod"]'},
        }
