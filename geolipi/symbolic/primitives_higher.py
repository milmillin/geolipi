...
class Revolution3D(HigherOrderPrimitives3D):
    ...
    def default_spec(cls):
        return {"input": {"type": "Expr"}, "radius": {"type": "float", "min": 0.0}}
...
class SimpleExtrusion3D(CurvePrimitive3D):
    @classmethod
    def default_spec(cls):
        return {"input": {"type": "Expr"}, "height": {"type": "float"}}
...
class QuadraticBezierExtrude3D(CurvePrimitive3D):
    @classmethod
    def default_spec(cls):
        return {"input": {"type": "Expr"}, "control": {"type": "Vector[2]"}, "height": {"type": "float"}}
