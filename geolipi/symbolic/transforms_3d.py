...
class Affine3D(Transform3D):
    ...
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "matrix": {"type": "Matrix[4,4]"}}
...
class Translate3D(Transform3D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "offset": {"type": "Vector[3]"}}
...
class EulerRotate3D(Transform3D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "angles": {"type": "Vector[3]"}}
...
class AxisAngleRotate3D(Transform3D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "axis": {"type": "Vector[3]"}, "angle": {"type": "float"}}
...
class RotateMatrix3D(Transform3D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "matrix": {"type": "Matrix[3,3]"}}
...
class Scale3D(Transform3D):
    ...
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "scale": {"type": "Vector[3]"}}
...
class QuaternionRotate3D(Transform3D):
    ...
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "quat": {"type": "Vector[4]"}}
...
class Shear3D(Transform3D):
    ...
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "shear": {"type": "Vector[6]"}}
...
class Distort3D(PositionalTransform3D):
    ...
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "amount": {"type": "float"}}
