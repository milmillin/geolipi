...
class Translate2D(Transform2D):
    ...
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "offset": {"type": "Vector[2]"}}
...
class EulerRotate2D(Transform2D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "angle": {"type": "float"}}
...
class Scale2D(Transform2D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "scale": {"type": "Vector[2]"}}
...
class Shear2D(Transform2D):
    @classmethod
    def default_spec(cls):
        return {"expr": {"type": "Expr"}, "shear": {"type": "Vector[2]"}}
