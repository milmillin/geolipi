...
def compiled_unroll_comb(
    ...
    **kwargs,
    ...
    for child in tree_branches:
        ...
        local_context = rec_compiled_unroll(
            child, local_context, sketcher, secondary_sketcher, isolated_vars, *args, **kwargs
        )
